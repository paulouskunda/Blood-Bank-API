...
<html class="no-js" lang="zxx">
    ...
    <body>
		...
		<ul class="pro-features">
			<a class="get-pro" href="#"><B>LOGOUT</B></a>
			<li class="big-title">THANKS FOR USING THE SYSTEM </li>
			<li class="title">YOU MADE THE DIFFERENCE</li>
			<li></li>
			<li>PRESS THE BUTTON BELOW </li>
			
			<div class="button">
				
				<a href="logout.php" target="_blank" class="btn">LOGOUT HERE</a>
			</div>
		</ul>
							...
							<div class="main-menu">
								<nav class="navigation">
									<ul class="nav menu">
										...
										<li><a href="#">DONATE BLOOD<i class="icofont-rounded-down"></i></a>
											<ul class="dropdown">
												<li><a href="donate.php">Donate Details</a></li>
											</ul>
										</li>
																	</ul>
								</nav>
